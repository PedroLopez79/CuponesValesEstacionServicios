...
type
  ...
  public
    ...
    function IDTOCLAVE(Cual: Integer): Variant;
    function Folio(ACampo, ASerie: String): Integer;
    function FolioActual(ACampo, ASerie: String): Integer;
...
function TDM.FolioActual(ACampo, ASerie: String): Integer;
begin
   Result:=Servidor.FolioActual(ACampo, ASerie);
end;

function TDM.IDTOCLAVE(Cual: Integer): Variant;
begin
  Result:=  UtileriasComun.IDToClave(Cual);
end;
...
begin
  case Cual of
    1: Result:=Parametros.ClienteIni;
    2: Result:=Parametros.ClienteFin;
