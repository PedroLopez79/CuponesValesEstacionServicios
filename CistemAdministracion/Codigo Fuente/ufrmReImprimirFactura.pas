...
uses
  ...
  dxSkinXmas2008Blue, uDAInterfaces, dxSkinMetropolis, dxSkinMetropolisDark,
  dxSkinOffice2013DarkGray, dxSkinOffice2013LightGray, dxSkinOffice2013White,
  cxPCdxBarPopupMenu, uDAFields, uROComponent;
...
//uses dmImagenes;
uses Modules,uDM, dmActions, dmImagenes, UtileriasComun, LibraryValesCupones_Intf;
...
var
  Aux: LibraryValesCupones_Intf.TReporte;
begin
  try
