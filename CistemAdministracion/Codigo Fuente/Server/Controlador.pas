...
uses
  ...
  LibraryValesCupones_Intf, fServerDataModule, Dialogs, Forms;
...
begin
  ...
  for I := 1 to 3 do
  begin
    if (Global.Bombas[Bomba].Estado in [eEstadoBomba_ebAuto, eEstadoBomba_ebStop]) then
